...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".page-product__chars-slider", {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar],
  slidesPerView: "auto",
  freeMode: {
    enabled: true
  },
...
$(document).on("click", function (e) {
  ...
  if (!$target.hasClass("page-buy-map__country-popup") && $target.parents(".page-buy-map__country-popup").length === 0 && !$target.hasClass("page-buy-map__country-btn") && $target.parents(".page-buy-map__country-btn").length === 0) {
    $popup.removeClass("opened");
  }
});
...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".page-series__design-slider", {
...
/***/ "./source/js/for-partners-form-1.js":
/*!******************************************!*\
  !*** ./source/js/for-partners-form-1.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
...
const checkErrors = () => {
  if (hasNameError || hasSurnameError || hasCompanyError || hasEmailError || hasPhoneError || hasCityError || hasCheckError) {
...
/***/ "./source/js/for-partners-form.js":
/*!****************************************!*\
  !*** ./source/js/for-partners-form.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./source/js/intro-dowload-link.js":
/*!*****************************************!*\
  !*** ./source/js/intro-dowload-link.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
...
$(document).on("click", function (e) {
  ...
  if (!$target.hasClass("intro__download-block") && $target.parents(".intro__download-block").length === 0 && !$target.hasClass("intro__download-link") && $target.parents(".intro__download-link").length === 0) {
...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".intro__slider", {
...
if ($cards.length > 0) {
  ...
  scriptLoading("//api-maps.yandex.ru/2.1/?lang=ru_RU", () => {
    ymaps.ready(() => {
      let map = new ymaps.Map($(".contacts__map")[0], {
      ...
      $cards.each((idx, card) => {
        ...
        var squareLayout = ymaps.templateLayoutFactory.createClass(`<div id="placemarkr-${idx}" data-idx="${idx}" class="map-marker"></div>`);
        var squarePlacemark = new ymaps.Placemark(coordinates, {
        ...
        map.geoObjects.add(squarePlacemark); // const marker = new ymaps.Plasemark(
...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".page-index__news-slider", {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],
  freeMode: true,
  slidesPerView: 'auto',
  // spaceBetween: 24,
...
if ($(".office__map").length > 0) {
  ...
  scriptLoading("//api-maps.yandex.ru/2.1/?lang=ru_RU", () => {
    ymaps.ready(() => {
      let map = new ymaps.Map($(".office__map")[0], {
      ...
      var squareLayout = ymaps.templateLayoutFactory.createClass(`<div id="placemarkr-office" class="map-marker-office"></div>`);
      var squarePlacemark = new ymaps.Placemark([55.796567, 37.536931], {
        ...
        iconShape: {
          type: "Rectangle",
          // Прямоугольник описывается в виде двух точек - верхней левой и нижней правой.
          coordinates: [[-28, -56], [28, 0]]
        }
      });
      map.geoObjects.add(squarePlacemark); // $cards.each((idx, card) => {
      //   const coordinates = $(card).find(".coordinates").text().split(",");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var inputmask_dist_jquery_inputmask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! inputmask/dist/jquery.inputmask */ "./node_modules/inputmask/dist/jquery.inputmask.js");
...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".page-product__preview-slider", {
...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".page-product__slider .swiper", {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],
  slidesPerView: "auto",
  centeredSlides: true,
  pagination: {
...
const checkErrors = () => {
  if (hasNameError || hasSurnameError || hasPatronymicError || hasEmailError || hasPhoneError || hasCityError || hasMessageError || hasCheckError) {
    $submit.attr("disabled", true);
  } else {
    $submit.removeAttr("disabled");
  }
...
const onSubmit = e => {
  ...
  if (isNameValid && isSurnameValid && isPatronymicValid && isEmailValid && isPhoneValid && isCityValid && isMessageValid && isChecked) {
    $form.trigger("submit");
  } else {
    $submit.attr("disabled", true);
  }
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".tab-list-slider", {
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _intro_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./intro-slider */ "./source/js/intro-slider.js");
/* harmony import */ var _intro_dowload_link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./intro-dowload-link */ "./source/js/intro-dowload-link.js");
/* harmony import */ var _intro_dowload_link__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_intro_dowload_link__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _chars_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chars-slider */ "./source/js/chars-slider.js");
/* harmony import */ var _preview_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./preview-slider */ "./source/js/preview-slider.js");
/* harmony import */ var _phone_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./phone-mask */ "./source/js/phone-mask.js");
/* harmony import */ var _vrf_select_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vrf-select-modal */ "./source/js/vrf-select-modal.js");
/* harmony import */ var _vrf_select_modal__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_vrf_select_modal__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _get_price_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./get-price-modal */ "./source/js/get-price-modal.js");
/* harmony import */ var _get_price_modal__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_get_price_modal__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _for_partners_form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./for-partners-form */ "./source/js/for-partners-form.js");
/* harmony import */ var _for_partners_form__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_for_partners_form__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _for_partners_form_1__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./for-partners-form-1 */ "./source/js/for-partners-form-1.js");
/* harmony import */ var _for_partners_form_1__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_for_partners_form_1__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _maps__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./maps */ "./source/js/maps.js");
/* harmony import */ var _maps__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_maps__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _buy_tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./buy-tabs */ "./source/js/buy-tabs.js");
/* harmony import */ var _buy_tabs__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_buy_tabs__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _country_popup__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./country-popup */ "./source/js/country-popup.js");
/* harmony import */ var _country_popup__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_country_popup__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _tab_slider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./tab-slider */ "./source/js/tab-slider.js");
/* harmony import */ var _question_form__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./question-form */ "./source/js/question-form.js");
/* harmony import */ var _question_form__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_question_form__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _office_map__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./office-map */ "./source/js/office-map.js");
/* harmony import */ var _office_map__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_office_map__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _support_form__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./support-form */ "./source/js/support-form.js");
/* harmony import */ var _support_form__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_support_form__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _product_slider__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./product-slider */ "./source/js/product-slider.js");
/* harmony import */ var _catalog_btn__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./catalog-btn */ "./source/js/catalog-btn.js");
/* harmony import */ var _catalog_btn__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_catalog_btn__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var _news_slider__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./news-slider */ "./source/js/news-slider.js");
/* harmony import */ var _design_slider__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./design-slider */ "./source/js/design-slider.js");
